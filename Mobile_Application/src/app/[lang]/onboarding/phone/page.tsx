  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data.exists && data.user) {
        ...
        router.push(`${getLocalizedLink('/onboarding/otp')}?phone=${encodeURIComponent(formattedPhone)}`);
      } else {
        // New user - go to name/age screen
        router.push(`${getLocalizedLink('/onboarding/info')}?phone=${encodeURIComponent(formattedPhone)}`);
      }
    } catch (error) {
